...
(function (factory) {
    ...
    L.Control.PolylineMeasure = L.Control.extend({
        ...
        options: {
             ...
             * @default
             */
            tooltipTextFinish: 'Click para <b>terminar</b><br>',
            tooltipTextDelete: 'Presiona la tecla SHIFT y da click para <b>borrar punto</b>',
            tooltipTextMove: 'Click y arrastra para <b>mover punto</b><br>',
            tooltipTextResume: '<br>Presiona la tecla CTRL y da click para <b>reanudar</b>',
            tooltipTextAdd: 'Presiona la tecla CTRL y da click para <b>agregar punto</b>',
             ...
             * @default
             */
            measureControlTitleOn: "Inicia medición",
            /**
             * Title for the control going to be switched off
             * @type {String}
             * @default
             */
            measureControlTitleOff: "Termina medición",
            /**
             ...
             * @default
             */
            clearControlTitle: 'Limpia mediciones',
            /**
        ...
        onAdd: function(map) {
            ...
            if (this.options.showUnitControl) {
                ...
                }  else if  (this.options.unit == "millas") {
