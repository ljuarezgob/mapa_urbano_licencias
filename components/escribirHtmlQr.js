...
let impactogiro2 = urlParams.get('impactogiro2');
let factibilidaduso2 = urlParams.get('factibilidaduso2');
...
document.querySelectorAll(".giro-solicitado").forEach(span => {
    span.textContent = girosolicitado;
});
...
document.querySelectorAll(".giro-solicitado2").forEach(span => {
    span.textContent = giroSolicitado2;
});
//  document.querySelectorAll('girosolicitado2').textContent = giroSolicitado2;
